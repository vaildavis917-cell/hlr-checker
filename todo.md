...
## SEO Fix (2026-02-02)
- [x] Исправить title страницы (30-60 символов)


## GitHub Update (2026-02-02)
- [x] Обновить README.md
- [x] Обновить CHANGELOG.md
- [x] Закоммитить без API ключей
- [x] Запушить на GitHub
- [x] Создать тег v2.1.0


## Bug Fix: History View (2026-02-02)
- [x] Исправить кнопку просмотра в истории - должна показывать результаты батча, а не перенаправлять на HLR Проверка


## Bug Fix: Admin View Other Users' Batches (2026-02-02)
- [x] Исправить просмотр результатов чужих батчей для админа


## Follow-up Tasks (2026-02-02)
- [x] Исправление для Email-проверок - админ видит историю всех пользователей
- [x] Добавить имя пользователя в заголовок при просмотре чужой истории
- [x] Добавить кнопку просмотра на странице Email История
- [x] Добавить отображение владельца батча при просмотре чужих результатов (HLR и Email)
- [x] Закоммитить все изменения на GitHub (v2.2.0)


## Custom Roles System (2026-02-03)
- [x] Создать таблицу custom_roles в БД (id, name, description, permissions JSON, createdAt, updatedAt)
- [x] Backend API: создание роли (admin only)
- [x] Backend API: редактирование роли (admin only)
- [x] Backend API: удаление роли (admin only)
- [x] Backend API: получение списка ролей
- [x] UI: страница управления ролями в админ-панели
- [x] UI: форма создания новой роли с выбором permissions
- [x] UI: редактирование существующей роли
- [x] UI: удаление роли с подтверждением
- [ ] Интеграция: назначение кастомной роли пользователю (TODO)
- [x] Переводы для новой функциональности (RU/UK/EN)

## Email Improvements (2026-02-03)
- [x] Resume для email батчей: backend API для возобновления
- [x] Resume для email батчей: UI кнопка возобновления
- [x] Шаблоны экспорта email: диалог выбора полей
- [x] Сортировка email результатов по колонкам


## UI Fixes (2026-02-03)
- [x] Сделать карточки баланса API одинакового размера на Dashboard (h-[120px])

- [ ] Добавить подробную информацию о типах номеров (fixed_line, mobile и др.) в Help Center


## Help Center - Phone Number Types (2026-02-04)
- [x] Добавить подробную информацию о типах номеров (fixed_line, mobile и др.) в Help Center
- [x] Добавить таблицу с описанием всех типов номеров
- [x] Добавить информацию о поддержке SMS для каждого типа
- [x] Переводы на все языки (RU/UK/EN)


## Tooltip для типа номера (2026-02-04)
- [ ] Добавить всплывающую подсказку с описанием типа номера при наведении в таблице результатов HLR
- [ ] Обновить tooltip для Health Score - показывать конкретные значения (что есть/чего нет)


## Health Score Tooltip Improvement (2026-02-04)
- [x] Обновить tooltip для Health Score - показывать конкретные значения (что есть/чего нет)
- [x] Добавить tooltip для типа номера с описанием (mobile, fixed_line, voip и др.)
- [x] Добавить переводы для типов номеров (RU/UK/EN)


## Bug Fixes (2026-02-04)
- [x] Email батч не видит все адреса - исправлен regex валидации email
- [x] Кнопка "Начать проверку" - работает корректно (требуется имя батча)
...
## Bug Fixes - Email Validator (2026-02-04)
- [x] Кнопка "Начать проверку" не работает - исправлено (убрана обязательность поля названия)
