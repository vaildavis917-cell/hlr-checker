...
function getContent(lang: string) {
  const gsmCodesRu = [
    { code: "0", label: "OK (0)", variant: "default", meaning: "Delivered — номер активен и доступен", action: "Можно использовать" },
    { code: "1", label: "Bad Number (1)", variant: "destructive", meaning: "Unknown Subscriber — номер не существует", action: "Удалить из базы" },
    { code: "5", label: "Bad Number (5)", variant: "destructive", meaning: "Unidentified Subscriber — неопознанный абонент", action: "Удалить из базы" },
    { code: "6", label: "Absent (6)", variant: "secondary", meaning: "Absent Subscriber — телефон выключен или вне сети", action: "Повторить проверку позже" },
    { code: "27", label: "Absent (27)", variant: "secondary", meaning: "Absent Subscriber SM — абонент недоступен для SMS", action: "Повторить проверку позже" },
    { code: "9", label: "Blocked (9)", variant: "destructive", meaning: "Illegal Subscriber — номер заблокирован", action: "Удалить из базы" },
    { code: "12", label: "Blocked (12)", variant: "destructive", meaning: "Illegal Equipment — устройство заблокировано", action: "Удалить из базы" },
    { code: "13", label: "Barred (13)", variant: "secondary", meaning: "Call Barred — вызовы заблокированы", action: "Проверить вручную" },
    { code: "8", label: "Roaming (8)", variant: "secondary", meaning: "Roaming Not Allowed — абонент в роуминге", action: "Номер активен, но за границей" },
    { code: "10", label: "No Service (10)", variant: "secondary", meaning: "Bearer Service Not Provisioned — услуга не подключена", action: "Проверить тип номера" },
    { code: "11", label: "No Service (11)", variant: "secondary", meaning: "Teleservice Not Provisioned — услуга не поддерживается", action: "Проверить тип номера" },
    { code: "31", label: "Error (31)", variant: "secondary", meaning: "System Failure — системная ошибка", action: "Повторить проверку позже" },
    { code: "32", label: "No Data (32)", variant: "secondary", meaning: "Data Missing — данные отсутствуют", action: "Повторить проверку позже" },
  ];

  const gsmCodesUk = [
    { code: "0", label: "OK (0)", variant: "default", meaning: "Delivered — номер активний і доступний", action: "Можна використовувати" },
    { code: "1", label: "Bad Number (1)", variant: "destructive", meaning: "Unknown Subscriber — номер не існує", action: "Видалити з бази" },
    { code: "5", label: "Bad Number (5)", variant: "destructive", meaning: "Unidentified Subscriber — нерозпізнаний абонент", action: "Видалити з бази" },
    { code: "6", label: "Absent (6)", variant: "secondary", meaning: "Absent Subscriber — телефон вимкнено або поза мережею", action: "Повторити перевірку пізніше" },
    { code: "27", label: "Absent (27)", variant: "secondary", meaning: "Absent Subscriber SM — абонент недоступний для SMS", action: "Повторити перевірку пізніше" },
    { code: "9", label: "Blocked (9)", variant: "destructive", meaning: "Illegal Subscriber — номер заблоковано", action: "Видалити з бази" },
    { code: "12", label: "Blocked (12)", variant: "destructive", meaning: "Illegal Equipment — пристрій заблоковано", action: "Видалити з бази" },
    { code: "13", label: "Barred (13)", variant: "secondary", meaning: "Call Barred — виклики заблоковано", action: "Перевірити вручну" },
    { code: "8", label: "Roaming (8)", variant: "secondary", meaning: "Roaming Not Allowed — абонент у роумінгу", action: "Номер активний, але за кордоном" },
    { code: "10", label: "No Service (10)", variant: "secondary", meaning: "Bearer Service Not Provisioned — послуга не підключена", action: "Перевірити тип номера" },
    { code: "11", label: "No Service (11)", variant: "secondary", meaning: "Teleservice Not Provisioned — послуга не підтримується", action: "Перевірити тип номера" },
    { code: "31", label: "Error (31)", variant: "secondary", meaning: "System Failure — системна помилка", action: "Повторити перевірку пізніше" },
    { code: "32", label: "No Data (32)", variant: "secondary", meaning: "Data Missing — дані відсутні", action: "Повторити перевірку пізніше" },
  ];

  const gsmCodesEn = [
    { code: "0", label: "OK (0)", variant: "default", meaning: "Delivered — number is active and reachable", action: "Safe to use" },
    { code: "1", label: "Bad Number (1)", variant: "destructive", meaning: "Unknown Subscriber — number doesn't exist", action: "Remove from database" },
    { code: "5", label: "Bad Number (5)", variant: "destructive", meaning: "Unidentified Subscriber — unrecognized subscriber", action: "Remove from database" },
    { code: "6", label: "Absent (6)", variant: "secondary", meaning: "Absent Subscriber — phone is off or out of network", action: "Retry check later" },
    { code: "27", label: "Absent (27)", variant: "secondary", meaning: "Absent Subscriber SM — subscriber unavailable for SMS", action: "Retry check later" },
    { code: "9", label: "Blocked (9)", variant: "destructive", meaning: "Illegal Subscriber — number is blocked", action: "Remove from database" },
    { code: "12", label: "Blocked (12)", variant: "destructive", meaning: "Illegal Equipment — device is blocked", action: "Remove from database" },
    { code: "13", label: "Barred (13)", variant: "secondary", meaning: "Call Barred — calls are blocked", action: "Check manually" },
    { code: "8", label: "Roaming (8)", variant: "secondary", meaning: "Roaming Not Allowed — subscriber is roaming", action: "Number active but abroad" },
    { code: "10", label: "No Service (10)", variant: "secondary", meaning: "Bearer Service Not Provisioned — service not enabled", action: "Check number type" },
    { code: "11", label: "No Service (11)", variant: "secondary", meaning: "Teleservice Not Provisioned — service not supported", action: "Check number type" },
    { code: "31", label: "Error (31)", variant: "secondary", meaning: "System Failure — system error", action: "Retry check later" },
    { code: "32", label: "No Data (32)", variant: "secondary", meaning: "Data Missing — data not available", action: "Retry check later" },
  ];
