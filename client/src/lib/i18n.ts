...
const translations = {
  ru: {
    ...
    health: {
      ...
      networkType: "Тип сети",
      pts: "баллов",
      breakdown: "Расчёт оценки",
      yes: "Да",
      no: "Нет",
      notPorted: "Не перенесён",
      ported: "Перенесён",
      notRoaming: "Без роуминга",
      roaming: "В роуминге",
      unknown: "Неизвестно",
    },
    ...
    numberTypes: {
      ...
      mobileDesc: "Мобильный номер, поддерживает SMS",
      fixed_line: "Стационарный телефон",
      fixed_lineDesc: "Проводной телефон, не поддерживает SMS",
      fixed_line_or_mobile: "Стационарный или мобильный",
      fixed_line_or_mobileDesc: "Может быть как стационарным, так и мобильным",
      voip: "VoIP номер",
      voipDesc: "Интернет-телефония, ограниченная поддержка SMS",
      toll_free: "Бесплатный номер",
      toll_freeDesc: "Бесплатный для звонящего (8-800)",
      premium_rate: "Платный номер",
      premium_rateDesc: "Платный сервисный номер",
      shared_cost: "Разделённая стоимость",
      shared_costDesc: "Стоимость делится между звонящим и получателем",
      personal_number: "Персональный номер",
      personal_numberDesc: "Персональный номер с переадресацией",
      pager: "Пейджер",
      pagerDesc: "Устройство для получения сообщений",
      uan: "Универсальный номер",
      uanDesc: "Универсальный номер доступа (UAN)",
      unknown: "Неизвестный тип",
      unknownDesc: "Тип номера не удалось определить",
    },
  ...
  uk: {
    ...
    health: {
      ...
      networkType: "Тип мережі",
      pts: "балів",
      breakdown: "Розрахунок оцінки",
      yes: "Так",
      no: "Ні",
      notPorted: "Не перенесений",
      ported: "Перенесений",
      notRoaming: "Без роумінгу",
      roaming: "У роумінгу",
      unknown: "Невідомо",
    },
    ...
    numberTypes: {
      ...
      mobileDesc: "Мобільний номер, підтримує SMS",
      fixed_line: "Стаціонарний телефон",
      fixed_lineDesc: "Провідний телефон, не підтримує SMS",
      fixed_line_or_mobile: "Стаціонарний або мобільний",
      fixed_line_or_mobileDesc: "Може бути як стаціонарним, так і мобільним",
      voip: "VoIP номер",
      voipDesc: "Інтернет-телефонія, обмежена підтримка SMS",
      toll_free: "Безкоштовний номер",
      toll_freeDesc: "Безкоштовний для того, хто дзвонить (0-800)",
      premium_rate: "Платний номер",
      premium_rateDesc: "Платний сервісний номер",
      shared_cost: "Розділена вартість",
      shared_costDesc: "Вартість ділиться між тим, хто дзвонить, і отримувачем",
      personal_number: "Персональний номер",
      personal_numberDesc: "Персональний номер з переадресацією",
      pager: "Пейджер",
      pagerDesc: "Пристрій для отримання повідомлень",
      uan: "Універсальний номер",
      uanDesc: "Універсальний номер доступу (UAN)",
      unknown: "Невідомий тип",
      unknownDesc: "Тип номера не вдалося визначити",
    },
  ...
  en: {
    ...
    health: {
      ...
      yes: "Yes",
      no: "No",
      notPorted: "Not ported",
      ported: "Ported",
      notRoaming: "No roaming",
      roaming: "Roaming",
      unknown: "Unknown",
    },
    ...
    numberTypes: {
      mobile: "Mobile phone",
      mobileDesc: "Mobile number, supports SMS",
      fixed_line: "Fixed line",
      fixed_lineDesc: "Landline phone, does not support SMS",
      fixed_line_or_mobile: "Fixed line or mobile",
      fixed_line_or_mobileDesc: "Could be either fixed line or mobile",
      voip: "VoIP number",
      voipDesc: "Internet telephony, limited SMS support",
      toll_free: "Toll-free number",
      toll_freeDesc: "Free for the caller (e.g., 800 numbers)",
      premium_rate: "Premium rate",
      premium_rateDesc: "Paid service number",
      shared_cost: "Shared cost",
      shared_costDesc: "Cost shared between caller and recipient",
      personal_number: "Personal number",
      personal_numberDesc: "Personal number with forwarding",
      pager: "Pager",
      pagerDesc: "Device for receiving messages",
      uan: "Universal access number",
      uanDesc: "Universal Access Number (UAN)",
      unknown: "Unknown type",
      unknownDesc: "Number type could not be determined",
    },
